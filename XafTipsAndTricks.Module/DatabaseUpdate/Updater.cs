...
namespace XafTipsAndTricks.Module.DatabaseUpdate {
    ...
    public class Updater : ModuleUpdater {
        ...
        public override void UpdateDatabaseAfterUpdateSchema() {
            ...
            ClassWithoutAttributes theObject = ObjectSpace.FirstOrDefault<ClassWithoutAttributes>(u => u.Name == "Joche");
            if (theObject == null)
            {
                theObject = ObjectSpace.CreateObject<ClassWithoutAttributes>();
                theObject.Name = "Joche";
            }
