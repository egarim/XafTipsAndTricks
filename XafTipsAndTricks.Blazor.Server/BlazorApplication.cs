...
namespace XafTipsAndTricks.Blazor.Server {
    public partial class XafTipsAndTricksBlazorApplication : BlazorApplication {
        public XafTipsAndTricksBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void XafTipsAndTricksBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
